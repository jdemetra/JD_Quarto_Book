...
A **pdf version** of this documentation is available [here](https://github.com/jdemetra/JD_Quarto_Book/blob/main/_book/JDemetra%2B-documentation.pdf)
...
- for the v3.x family: [here](https://github.com/jdemetra/jdplus-main/releases)
...
- for the v2.x family: [here](https://github.com/jdemetra/jdemetra-app/releases)
...
JDemetra+ is developed and maintained in the framework of the Eurostat co-founded COSA (**CO**fidentiality **S**easonal **A**djustment and time series) project. 
...
More information  on the project's website [https://cosa-grant.org/](https://cosa-grant.org/)
