...
<!-- - a part from X13 and TS: where else ? stl ? hf ? bsm ? -->

| Test | Purpose | Dispaly in GUI | R stand alone | R in SA estimation |
|--------------|--------------|--------------|--------------|-----------------|
| Ljung-Box | autocorrelation | ✔️ | rjd3toolkit | rjd3x13 / rjd3tramoseats |
| Box-Pierce | autocorrelation | ✔️ |  |  |
| Doornik-Hansen | normality | ✔️ | rjd3toolkit |  |

Specify (only in v3) - GUI output item - Cruncher input / output - rjd3x13 for instance: - default output - user defined output - rjd3 toolkit: R stand alone n
