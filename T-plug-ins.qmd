...
+=======================================================================================================+=========================================+=====================+
| X12+                                                                                                  | jdplus-x12plus-desktop-plugin-x.y.z.nbm | upcoming            |
|                                                                                                       |                                         |                     |
| Airline based pre-adjustment and extended X11 decomposition                                           |                                         |                     |
+-------------------------------------------------------------------------------------------------------+-----------------------------------------+---------------------+
| STL+                                                                                                  | jdplus-stl-desktop-plugin-x.y.z.nbm     | upcoming            |
|                                                                                                       |                                         |                     |
| Airline based pre-adjustment and STL (Loess) decomposition                                            |                                         |                     |
+-------------------------------------------------------------------------------------------------------+-----------------------------------------+---------------------+
| STS+                                                                                                  | jdplus-sts-desktop-plugin-x.y.z.nbm     | upcoming            |
|                                                                                                       |                                         |                     |
...
+============================================================+==========================================+=================+
| Extended Airline Estimation                                | jdplus-highfreq-desktop-plugin-x.y.z.nbm | upcoming        |
|                                                            |                                          |                 |
| (Reg-ARIMA Modelling)                                      |                                          |                 |
+------------------------------------------------------------+------------------------------------------+-----------------+
| Extended Airline Decomposition                             | jdplus-highfreq-desktop-plugin-x.y.z.nbm | upcoming        |
|                                                            |                                          |                 |
| (Extended Seats)                                           |                                          |                 |
+------------------------------------------------------------+------------------------------------------+-----------------+
...
+------------------------------------------------------------+------------------------------------------+-----------------+
| MSTL+                                                      | jdplus-stl-desktop-plugin-x.y.z.nbm      | upcoming        |
|                                                            |                                          |                 |
...
### Job Vacancy Survey (JVS) Quality report (version 2)
...
The description of the quality report is in this same GitHub repository [here](https://github.com/Sace2015/EurostatQR/blob/master/2018-10-26%20A%20PlugIn%20For%20Eurostat%20Job%20Vacancy%20Survey.docx)
